...
module.exports = (user, channel, text = '', command = {}, botToken = null, callback) => {
  callback(null, {
    text: `Hello, welcome to the NFL Fantasy Football Slackbot "INFO" function. 
          \n This slackbot has a bunch of different functions that will help you win your fantasy football league.
          ...
          \n\n The "week_review" command will take input for a desired player's name and will filter all other players at the same position.
